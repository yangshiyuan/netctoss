...
<head>
  ...
  <script language="javascript" type="text/javascript">
    ...
    function startFee(id) {
      ...
      if (r) {
        window.location.href = "startCost.action?id=" + id;
        document.getElementById("operate_result_info").style.display = "block";
      }
    }
    // 停止
    function closeFee(id) {
      var r = window.confirm("确定要启用此资费吗？资费启用后将不能修改和删除。");
      if (r) {
        window.location.href = "closeCost.action?id=" + id;
        document.getElementById("operate_result_info").style.display = "block";
      }
      ...
      <table id="datalist">
        ...
        <s:iterator value="costs">
          <tr>
            ...
            <td><a href="cost_detail.action?id=<s:property value="id"/>"><s:property value="name"/></a></td>
            ...
            <td>
              ...
              <s:if test="status==0">
                <input type="button" value="暂停" class="btn_start" onclick="closeFee(<s:property value="id"/>);"/>
                <input type="button" value="修改" class="btn_modify"
                       onclick="location.href='toUpdateCost?id=<s:property value="id"/>';"/>
                <input type="button" value="删除" class="btn_delete" onclick="deleteFee(<s:property value="id"/>);"/>
              </s:if>
