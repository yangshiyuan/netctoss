...
<!--导航区域结束  -->
<!--主要区域开始-->
<form id="addFeeForm" action="addCost.action" method="post" class="main_form">
  <div class="text_info clearfix"><span>资费名称：</span></div>
  <div class="input_info">
    <input type="text" name="cost.name" id="name" class="width300"/>
    <span class="required">*</span>
    <div id="name_error" class="validate_msg_short">50长度的字母、数字、汉字和下划线的组合</div>
  </div>
