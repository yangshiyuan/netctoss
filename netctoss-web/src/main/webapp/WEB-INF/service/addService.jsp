...
<head>
  ...
  <script language="javascript" type="text/javascript">
    ...
    function searchAccount() {
      ...
      $.post(
          "/NETCTOSS/account/searchAccount",
          {"idcardNo": idcardNo},
          function (data) {
            var account = data;
            if (account == null) {
...
<div id="main">
  ...
  <form action="" method="" class="main_form">
    ...
    <div class="input_info">
      <input type="text" id="loginName" readonly="readonly" onkeyup="searchAccounts(this);"/>
      <span class="required">*</span>
      <div class="validate_msg_long">没有此账务账号，请重新录入。</div>
    </div>
    <div class="text_info clearfix"><span>资费类型：</span></div>
    <div class="input_info">
      <s:select name="" list="costs" listKey="id" listValue="name"></s:select>
    </div>
