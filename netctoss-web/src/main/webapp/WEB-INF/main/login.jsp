  ...
  <form action="login" method="post">
    <table>
      <tr>
        ...
        <td colspan="2"><input name="adminCode" type="text" class="width150" value="<s:property value="adminCode"/>"/>
        </td>
        <td class="login_error_info"><span class="required">30长度的字母、数字和下划线</span></td>
      </tr>
      <tr>
        <td class="login_info">密码：</td>
        <td colspan="2"><input name="password" type="password" class="width150" value="<s:property value="password"/>"/>
        </td>
